...
# pacman
PACKAGES=(
  sway waybar fuzzel dunst kitty nwg-look qt5ct qt6ct btop steam \
  ...
  xdg-desktop-portal qbittorrent tailscale firefox flatpak
)
...
# paru packages
paru -S --noconfirm protonup-qt sunshine
